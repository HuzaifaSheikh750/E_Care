        ...
        <div className="container ">
          <div className="row align-items-center">
            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
              <div className="text-wrapper main_text" data-aos="fade-right" style={{marginTop:"280px"}}>
                ...
                >
                  ...
                  <a
                    href="https://appsource.microsoft.com/en-us/product/dynamics-365/kaispellc.kspmpportal?tab=Overview"
                    target="_blank"
            ...
            >
              ...
              >
                <img
                  src="/images/care/mainTablet.png"
                  alt="img"
                  className="lazy-img top_img"
                  // style={{width:"100%", height:"100%", marginLeft:"50px" }}
                  style={{position:"relative", right:"0px", top:"130px", width:"100%", height:"100%"}}
                />
              </div>
            </div>
            {/* End col-6 */}
